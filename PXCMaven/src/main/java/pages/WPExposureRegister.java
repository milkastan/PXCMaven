...
public class WPExposureRegister extends LoadableComponent<WPExposureRegister>{
	  private final static String title = "Eksponeringsregister";
		
		public WPExposureRegister() {
		...
		protected void isLoaded() throws Error {
		  Assert.assertTrue("Expected page title is not as actual",Browser.driver().getTitle().equals(title));
			...
			System.out.println("Loaded page: "+Browser.driver.findElement(By.id("cpmain_cpTitle_lblWorkingRegisterTitle")).getText());
