...
public class CreateSDS extends LoadableComponent<CreateSDS>{
    ...
    //0 - SDS mixture, 1 - SDS pure substance, 2- SDS substance
    public EditSDS CreateNewSDS (int sdstype) {
    	SelectSDSType(sdstype);
    	SDSCreateBtn.click();
    	wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("cpmain_lblTitle")));
    	System.out.println("Edit new SDS page is opened: "+ Browser.driver.findElement(By.id("cpmain_lblTitle")).getText());
    	return new EditSDS();
    }
